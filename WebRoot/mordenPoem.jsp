 ...
 <body class="homepage">
        ...
        <div id="header-wrapper">
            ...
            <div id="header" class="container">
                ...
                <nav id="nav">
                    ...
                    <ul>
                        <li ><a href="/new/mordenPoem.do?type=3&userId=${userId }">原创诗</a></li>
                        <li ><a href="/new/mordenPoem.do?type=1&userId=${userId }">古诗</a></li>
                        <li class="current_page_item"><a href="/new/mordenPoem.do?type=2&userId=${userId}">现代诗</a></li>
                        <li><a href="/new/mordenPoem.do?type=4&userId=${userId}">我要写诗</a></li>  
                    </ul>          
                </nav>            
            </div>
        </div>
    ...
    <div class="slider"><!--主体结构，请用此类名调用插件，此类名可自定义-->
       ...
       <c:forEach items="${reco}" var="image">
            <li><a href="/new/moderndisplay.do?poemId=${image.poemId}&userId=${userId }"><img src="${image. filepath}" alt="${image.title }" /></a></li>
            </c:forEach>
        </ul>
    </div>
</div>
                              ...
                              <div id="two-column">
                                <div class="row"> 
                                    <section class="6u">
                                        ...
                                        <ul>
                                        <c:forEach items="${pl11}" var="poem">
                                        <li>
                                                <a href="/new/moderndisplay.do?poemId=${poem.idpoem}&userId=${userId }">${poem.ptitle}</a>
                                    ...
                                    <br/>
                                    <section class="6u">
                                        <p style="font-size: 15px;">格律诗</p>
                                        <ul>
                                           <c:forEach items="${pl13}" var="poem">
                                        <li>
                                                <a href="/new/moderndisplay.do?poemId=${poem.idpoem}&userId=${userId }">${poem.ptitle}</a>
                                    ...
                                    <section class="6u">
                                        <p style="font-size: 15px;">自由诗</p>
                                        <ul>
                                           <c:forEach items="${pl14}" var="poem">
                                        <li>
                                                <a href="/new/moderndisplay.do?poemId=${poem.idpoem}&userId=${userId }">${poem.ptitle}</a>
                                    ...
                                    <br/>
                                     <section class="6u">
                                        <p style="font-size: 15px;">散文诗</p>
                                        <ul>
                                          <c:forEach items="${pl15}" var="poem">
                                        <li>
                                                <a href="/new/moderndisplay.do?poemId=${poem.idpoem}&userId=${userId }">${poem.ptitle}</a>
                                    ...
                                    <section class="6u">
                                        <p style="font-size: 15px;">韵脚诗</p>
                                        <ul>
                                          <c:forEach items="${pl16}" var="poem">
                                        <li>
                                                <a href="/new/moderndisplay.do?poemId=${poem.idpoem}&userId=${userId }">${poem.ptitle}</a>
                                    ...
                                    <br/>
                                    <section class="6u">
                                        <p style="font-size: 15px;">外国诗</p>
                                        <ul>
                                         <c:forEach items="${pl17}" var="poem">
                                        <li>
                                                <a href="/new/moderndisplay.do?poemId=${poem.idpoem}&userId=${userId }">${poem.ptitle}</a>
                                ...
                                <section id="box1" class="6u">
                                    ...
                                    <ul class="style4">
                                       <c:forEach items="${hotPoems}" var="poem">
                                        <li><a href="/new/moderndisplay.do?poemId=${poem.idpoem}&userId=${userId }">${ poem.ptitle}</a></li>
                                        </c:forEach>
                                    </ul>
                                </section>
                                <section class="6u">
                            ...
                            <section id="box2">
                                ...
                                <ul class="style2">
                                  <c:forEach items="${random }" var="poem">
                                    <li>
                                        <p><a href="/new/moderndisplay.do?poemId=${poem.poemId}&userId=${userId }"><img src="${poem.filepath }" alt="">${poem.title }</a></p>
                                    </li>
                                   </c:forEach>
                                 </ul>
                                    <br>
