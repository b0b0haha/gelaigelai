 ...
 * 
 * @see com.gelaigelai.domain.News
...
public class NewsDAO extends HibernateDaoSupport {
	...
	// property constants
	public static final String NINFO = "ninfo";
	...
	public List findByNinfo(Object ninfo) {
		return findByProperty(NINFO, ninfo);
	}

	public List findByNtype(Object ntype) {
		return findByProperty(NTYPE, ntype);
	}
