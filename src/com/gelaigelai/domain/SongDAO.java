 ...
 * 
 * @see com.gelaigelai.domain.Song
 * @author MyEclipse Persistence Tools
 */
public class SongDAO extends HibernateDaoSupport {
	...
	public Song findById(java.lang.Integer id) {
		...
		try {
			Song instance = (Song) getHibernateTemplate().get(
					"com.gelaigelai.domain.Song", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public Song merge(Song detachedInstance) {
		...
		try {
			Song result = (Song) getHibernateTemplate().merge(detachedInstance);
	...
	public static SongDAO getFromApplicationContext(ApplicationContext ctx) {
		return (SongDAO) ctx.getBean("SongDAO");
	}
}